...
public class TestePoupanca {
    ...
    public static void main(String[] args) {
        ...
        String agencia, num;
        agencia = JOptionPane.showInputDialog("Digite o número da agencia: ");
        ...
        cp = new Conta_poupanca (agencia, num, saldo, taxa);
        
        //Utilização dos dados para o objeto do tipo Conta poupança
